BIN = longmynd
SRC = main.c nim.c ftdi.c stv0910.c stv0910_utils.c stv0903.c stvvglna.c stvvglna_utils.c stv6120.c stv6120_utils.c stb6100.c ftdi_usb.c fifo.c udp.c beep.c ts.c
OBJ = ${SRC:.c=.o}
